...
namespace CARDMAKER
{
    public partial class MultipleCards : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string SQL = "SELECT * FROM [dbo].[ImportData] where [ImportName] = '" + comboBox1.Text.ToString() + "'";
        ...
        private void MultipleCards_Load(object sender, EventArgs e)
        {
            ChoosefileName();
            ChooseDesign();
        }
        ...
        private void comboBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            using (SqlConnection connection = CONNECTION.CONN())
            {
                ...
                string fetachSlidesRecentSQL = "select * FROM [dbo].[ImportData] where [ImportName] = '" + comboBox1.Text + "'";
